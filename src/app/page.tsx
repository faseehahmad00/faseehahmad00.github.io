...
import logort from '@/images/logos/airbnb.svg'
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            Feel free to reach out for collaborations, project inquiries, or just to say hello! Let’s connect and create something amazing together.
            </p>
            <dl className="mt-10 space-y-4 text-base/7">
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="tel:+923244672725" className="0">
                    +92 (324) 4672725
                  </a>
                </dd>
              </div>
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="mailto:contact@faseeh.dev" className="">
                    contact@faseeh.dev
                  </a>
                </dd>
              </div>
              ...
              <div>
                ...
                <div className="mt-2.5">
                  <input
                    ...
                    className="block w-full rounded-md px-3.5 py-2 text-base outline outline-1 -outline-offset-1 outline-gray-300 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600"
                  />
                </div>
              </div>
              <div>
              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-2.5">
                  <input
                    ...
                    type="tel"
                    autoComplete="tel"
                    className="block w-full rounded-md px-3.5 py-2 outline outline-1 -outline-offset-1 outline-gray-300 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600"
                  />
                </div>
              </div>
              <div className="sm:col-span-2">
...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://drive.usercontent.google.com/download?id=1Ls1XVm2aioQ6VMen6Sd_BedWRwLWMOkB&export=download" variant="secondary" className="group mt-6 w-full">
        Download CV
...
export default async function Home() {
  return (
    <>
      ...
      <Container className="mt-24 md:mt-28 y-8 gap-8">
            <Resume />
            <ContactMeForm/>
      </Container>
    </>
